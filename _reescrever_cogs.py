...
inicio = text.index('    cog_conteudos = {')
fim = text.index('    arquivos.append({"caminho": "cogs/geral.py"', inicio)
novo = r'''    cog_conteudos = {
...
'''
path.write_text(text[:inicio] + novo + text[fim:], encoding='utf-8')
